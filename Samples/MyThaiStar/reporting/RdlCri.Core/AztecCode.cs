...
namespace fyiReporting.CRI
{
    public class AztecCode : ICustomReportItem
    {
        ...
        internal void DrawImage(ref Bitmap bm, string aztecCode)
        {
        ...
        /// </summary>
        /// <param name="bm"></param>
        void DrawDesignerImage(ref System.DrawingCore.Bitmap bm)
        {
        ...
        void ICustomReportItem.DrawImage(ref Bitmap bm)
        {
            throw new NotImplementedException();
        }

        void ICustomReportItem.DrawDesignerImage(ref Bitmap bm)
        {
            //see qr
            throw new NotImplementedException();
        }
