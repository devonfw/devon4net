...
namespace fyiReporting.RDL
{
    ...
    internal class EmfLinearGradientBrush : EMFBrush
    {
        public EmfLinearGradientBrush(BinaryReader _br)
        {
            ...
            _br.ReadBytes(8);            
            System.DrawingCore.Drawing2D.LinearGradientBrush tmpB = new System.DrawingCore.Drawing2D.LinearGradientBrush(rf, Color.FromArgb(sA, sR, sG, sB), Color.FromArgb(eA, eR, eG, eB), 0f);
            tmpB.WrapMode = (System.DrawingCore.Drawing2D.WrapMode)WrapMode;
