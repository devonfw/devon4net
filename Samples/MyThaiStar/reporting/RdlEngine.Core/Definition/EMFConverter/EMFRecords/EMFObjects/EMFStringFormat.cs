...
namespace fyiReporting.RDL
{
    ...
    internal class EMFStringFormat : EMFRecordObject
    {
        ...
        private EMFStringFormat(byte[] RecordData)        
        {
            ...
            myStringFormat = new System.DrawingCore.StringFormat();
            ...
            myStringFormat.HotkeyPrefix = (System.DrawingCore.Text.HotkeyPrefix) _br.ReadInt32();
            ...
            Single[] TabStopArray;           
            System.DrawingCore.CharacterRange[] RangeArray;
            ...
            if (RangeCount > 0)
            {
                RangeArray = new System.DrawingCore.CharacterRange[RangeCount];
