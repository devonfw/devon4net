...
[source, c#]
----
builder.Services.AddKafkaProducer<MessageProducerHandler, string, string>("Producer1");
----
...
[source, c#]
----
builder.Services.AddKafkaConsumer<MessageConsumerHandler, string, string>("Consumer1");
----
...
The StreamBuilder will allow you to add all the logic to the stream. You can check https://lgouellec.github.io/kafka-streams-dotnet/[Streamiz Docs] to learn about the Stateless and Statefull Processors available on Kafka Streams.
...
[source, c#]
----
builder.Services.AddKafkaProducer<MessageProducerHandler, string, string>("message_stream", valueSerializer: new CustomSerializer());
----
...
[source, c#]
----
builder.Services.AddKafkaConsumer<MessageConsumerHandler, string, string>("Consumer1", keyDeserializer: new CustomDeserializer());
----
...
[source, c#]
----
public class CustomKafkaSerDes<T> : ISerDes<T>
{
...
[source, c#]
----
builder.Services.AddKafkaStreamService<MessageStreamService, string, string>("message_stream", keySerDes: new CustomKafkaSerDes(), valueSerDes: new CustomKafkaSerDes());
----
