...
Some templates have already all he packages referenced so you won't need to install anything. If that is not the case, you can install it as explained in the next section.
