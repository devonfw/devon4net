...
namespace Devon4Net.Infrastructure.AWS.CDK.Resources.Handlers.DMS
{
    ...
    {
        CfnEndpoint CreateEndpoint(string identification, string endpointType, string engineName, string databaseHost, double databasePort, string databaseName, string databaseUsername, string databasePassword, string endpointName = null);//NOSONAR number of params
