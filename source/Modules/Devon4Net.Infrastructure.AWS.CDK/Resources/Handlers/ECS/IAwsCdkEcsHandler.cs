...
namespace Devon4Net.Infrastructure.AWS.CDK.Resources.Handlers.ECS
{
    public interface IAwsCdkEcsHandler
    {
        ...
        IService CreateEc2Service(string id, string serviceName, ICluster cluster, TaskDefinition taskDefinition, int? healthCheckGracePeriod, List<CapacityProviderStrategy> capacityProviderStrategies, int? desiredCount, bool useDistinctInstances, string placementStrategy);
