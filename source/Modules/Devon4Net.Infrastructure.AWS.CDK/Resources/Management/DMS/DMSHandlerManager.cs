...
namespace Devon4Net.Infrastructure.AWS.CDK.Resources.Management
{
    public partial class AwsCdkHandlerManager 
    {
        ...
        public CfnEndpoint CreateDmsEndpoint(string identification, string endpointType, string engineName, string databaseHost, double databasePort, string databaseName, string databaseUsername, string databasePassword, string endpointName = null)
        {
        ...
        public CfnReplicationSubnetGroup CreateDmsReplicationSubnetGroup(
        ...
        public CfnReplicationInstance CreateDmsReplicationInstance(
            string identification,
        ...
        public CfnReplicationTask CreateDmsMigrationTasks(
            string identification,
