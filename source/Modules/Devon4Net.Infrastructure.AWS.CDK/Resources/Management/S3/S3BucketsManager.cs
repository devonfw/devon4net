...
namespace Devon4Net.Infrastructure.AWS.CDK.Resources.Management
{
    public partial class AwsCdkHandlerManager : IS3BucketsManager
    {
        ...
        {
            return HandlerResources.AwsCdkS3Handler.AddLifeCycleRuleToExistingBucket(identification, bucketName, lifecycleRuleList);
        }

        public void AddLifeCycleRuleToExistingBucket(ref IBucket bucket, List<ILifecycleRule> lifecycleRuleList)
        {
            HandlerResources.AwsCdkS3Handler.AddLifeCycleRuleToExistingBucket(ref bucket, lifecycleRuleList);
        }
    }
}
