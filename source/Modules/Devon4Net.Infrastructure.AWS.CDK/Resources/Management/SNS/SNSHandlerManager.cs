...
namespace Devon4Net.Infrastructure.AWS.CDK.Resources.Management
{
    public partial class AwsCdkHandlerManager
    {
        ...
        public EmailSubscription CreateEmailSubscription(string emailAddress, bool? json = null, IDictionary<string, Amazon.CDK.AWS.SNS.SubscriptionFilter> filterPolicy = null, IQueue queue = null)
        {
