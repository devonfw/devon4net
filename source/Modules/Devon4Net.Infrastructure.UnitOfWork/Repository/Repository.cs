...
public class Repository<T> : IRepository<T> where T : class
{
    ...
    /// <param name="dbContextBehaviour">
    ///     Sets the AutoDetectChangesEnabled, LazyLoadingEnabled and QueryTrackingBehavior flag
    ///     to true or false
    /// </param>
    protected Repository(DbContext context, bool dbContextBehaviour = false)
    {
        DbContext = context;
