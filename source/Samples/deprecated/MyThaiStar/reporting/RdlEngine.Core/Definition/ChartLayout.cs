...
namespace fyiReporting.RDL
{
	...
	internal class ChartLayout
	{
		...
		int _TopMargin;
		int _BottomMargin;
		System.DrawingCore.Rectangle _PlotArea;
		...
		internal int LeftMargin
		{
            ...
            set { _LeftMargin = value; _PlotArea = System.DrawingCore.Rectangle.Empty; }
		}
		internal int RightMargin
		{
			get { return  _RightMargin; }
            set { _RightMargin = value; _PlotArea = System.DrawingCore.Rectangle.Empty; }
		}
		internal int TopMargin
		{
			get { return  _TopMargin; }
            set { _TopMargin = value; _PlotArea = System.DrawingCore.Rectangle.Empty; }
		}
		internal int BottomMargin
		{
			get { return  _BottomMargin; }
            set { _BottomMargin = value; _PlotArea = System.DrawingCore.Rectangle.Empty; }
		}
		internal System.DrawingCore.Rectangle PlotArea
		{
			get 
			{ 
				if (_PlotArea == System.DrawingCore.Rectangle.Empty)
				{
					...
					_PlotArea = new System.DrawingCore.Rectangle(_LeftMargin, _TopMargin, w, h); 
				}
