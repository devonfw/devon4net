...
namespace fyiReporting.RDL
{
	...
	public class RDLParser
	{
        ...
        public Report Parse(List<Param> sqlParams)
        {
            return Parse(0,sqlParams);
        }

        internal Report Parse(int oc, List<Param> sqlParams = null)
			{
			...
			ReportDefn rd = new ReportDefn(xNode, rl, this._Folder, this._DataSourceReferencePassword, oc, OnSubReportGetContent, OverwriteConnectionString, OverwriteInSubreport, sqlParams);
