...
namespace fyiReporting.RDL
{
	...
	internal class Style : ReportLink
	{
		...
		internal void DrawBackground(Report rpt, Graphics g, Row r, System.DrawingCore.Rectangle rect)
		{
				...
				this.BackgroundColor != null)
			{
				...
				Color c = XmlUtil.ColorFromHtml(bgc, System.DrawingCore.Color.White, rpt);

				string bgec = this.BackgroundGradientEndColor.EvaluateString(rpt, r);
				Color ec = XmlUtil.ColorFromHtml(bgec, System.DrawingCore.Color.White, rpt);
		...
		internal void DrawBackgroundCircle(Report rpt, Graphics g, Row r, System.DrawingCore.Rectangle rect)
		{
		...
		internal void DrawBorder(Report rpt, Graphics g, Row r, System.DrawingCore.Rectangle rect)
		{
			...
			topColor = bottomColor = leftColor = rightColor = System.DrawingCore.Color.Black;
			if (BorderColor != null)
			{
				if (BorderColor.Default != null)
				{
					...
					topColor = bottomColor = leftColor = rightColor = 
						XmlUtil.ColorFromHtml(v, System.DrawingCore.Color.Black, rpt);
				}
				if (BorderColor.Top != null)
				{
					v = BorderColor.Top.EvaluateString(rpt, r);
					topColor = XmlUtil.ColorFromHtml(v, System.DrawingCore.Color.Black, rpt);
				}
				if (BorderColor.Bottom != null)
				{
					v = BorderColor.Bottom.EvaluateString(rpt, r);
					bottomColor = XmlUtil.ColorFromHtml(v, System.DrawingCore.Color.Black, rpt);
				}
				if (BorderColor.Left != null)
				{
					v = BorderColor.Left.EvaluateString(rpt, r);
					leftColor = XmlUtil.ColorFromHtml(v, System.DrawingCore.Color.Black, rpt);
				}
				if (BorderColor.Right != null)
				{
					v = BorderColor.Right.EvaluateString(rpt, r);
					rightColor = XmlUtil.ColorFromHtml(v, System.DrawingCore.Color.Black, rpt);
				}
			}
		...
		internal void DrawStyleLine(Report rpt, Graphics g, Row r, Point s, Point e)
		{
			...
			{
				int width;
				System.DrawingCore.Color color;
				BorderStyleEnum bs;
				...
				if (BorderColor != null && BorderColor.Default != null)
				{
					...
					color = XmlUtil.ColorFromHtml(v, System.DrawingCore.Color.Black, rpt);
				}
				else
					color = System.DrawingCore.Color.Black;
		...
		//  information
		internal void DrawString(Report rpt, Graphics g, object o, TypeCode tc, Row r, System.DrawingCore.Rectangle rect)
		{
		...
		static internal void DrawStringDefaults(Graphics g, object o, System.DrawingCore.Rectangle rect)
		{
			Font drawFont=null;
			...
			try
			{
				...
				drawBrush = new SolidBrush(System.DrawingCore.Color.Black);
                ...
                if (len.Width > rect.Width)
                {
                    ...
                    rect = (new System.DrawingCore.Rectangle(rect.X, rect.Y, rect.Width, (int)len.Width));
		...
		internal Brush GetBrush(Report rpt, Row r)
		{
			...
			if (this.Color != null)
			{
				...
				Color color = XmlUtil.ColorFromHtml(c, System.DrawingCore.Color.Black, rpt);
		...
		internal StyleInfo GetStyleInfo(Report rpt, Row r)
		{
			...
			if (si.BackgroundColor == System.DrawingCore.Color.Empty)
			{
		...
		internal System.DrawingCore.Rectangle PaddingAdjust(Report rpt, Row r, System.DrawingCore.Rectangle rect, bool bAddIn)
		{
			...
			System.DrawingCore.Rectangle rt;
			if (bAddIn)		// add in when trying to size the object
				rt = new System.DrawingCore.Rectangle(rect.Left - pleft, rect.Top - ptop, 
		...
		{
			if (_BackgroundColor == null)
				return System.DrawingCore.Color.Empty;

			string c = _BackgroundColor.EvaluateString(rpt, row);
			return XmlUtil.ColorFromHtml(c, System.DrawingCore.Color.Empty, rpt);
		}
		...
		{
			if (_Color == null)
				return System.DrawingCore.Color.Black;

			string c = _Color.EvaluateString(rpt, row);
			return XmlUtil.ColorFromHtml(c, System.DrawingCore.Color.Black, rpt);
		}
