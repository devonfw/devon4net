...
namespace fyiReporting.RDL
{
    ...
    internal class RenderTif : IPresent
    {
        ...
        private void ProcessHtml(PageTextHtml pth, System.DrawingCore.Graphics g)
        {
        ...
        private Bitmap ConvertToBitonal(Bitmap original)
        {
            ...
            BitmapData sourceData = source.LockBits(new System.DrawingCore.Rectangle(0, 0, source.Width, source.Height), ImageLockMode.ReadOnly, PixelFormat.Format32bppArgb);
            ...
            BitmapData destinationData = destination.LockBits(new System.DrawingCore.Rectangle(0, 0, destination.Width, destination.Height), ImageLockMode.WriteOnly, PixelFormat.Format1bppIndexed);
        ...
        private void SaveBitmap(Bitmap tif, Bitmap bm, Stream st, int pageNo)
        {
            if (pageNo == 1)
            {
                ...
                encoderParams.Param[0] = new EncoderParameter(
                    System.DrawingCore.Imaging.Encoder.SaveFlag, (long)EncoderValue.MultiFrame
                );

                encoderParams.Param[1] = new EncoderParameter(
                    System.DrawingCore.Imaging.Encoder.Compression, 
            ...
            else
            {
                ...
                encoderParams.Param[0] = new EncoderParameter(
                    System.DrawingCore.Imaging.Encoder.SaveFlag, (long)EncoderValue.FrameDimensionPage
                );
