...
namespace fyiReporting.RDL
{
	...
	public interface ICustomReportItem : IDisposable    
	{
        ...
        void DrawImage(ref System.DrawingCore.Bitmap bm);       // Draw the image in the passed bitmap; do SetParameters first
        void DrawDesignerImage(ref System.DrawingCore.Bitmap bm);   // Design time: Draw the designer image in the passed bitmap;
        ...
        void DrawImage(ref MemoryStream ms, int height, int weight);
    }
