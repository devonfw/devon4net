...
namespace fyiReporting.RDL
{
	...
	public class StyleInfo: ICloneable
	{
		...
		public StyleInfo()
		{
			BColorLeft = BColorRight = BColorTop = BColorBottom = System.DrawingCore.Color.Black;	// (Color) Color of the bottom border
			BStyleLeft = BStyleRight = BStyleTop = BStyleBottom = BorderStyleEnum.None;
			// _BorderWdith
			BWidthLeft = BWidthRight = BWidthTop = BWidthBottom = 1;

			BackgroundColor = System.DrawingCore.Color.Empty;
            BackgroundColorText = string.Empty;
			BackgroundGradientType = BackgroundGradientTypeEnum.None;
			BackgroundGradientEndColor = System.DrawingCore.Color.Empty;
		...
		public static patternTypeEnum GetPatternType(System.DrawingCore.Drawing2D.HatchStyle hs)
		{
			switch (hs)
			{
